    ...
    <div id="kt_content_container" class="container-xxl">
        ...
        <div class="card">
                        ...
                        <div class="modal-dialog modal-dialog-centered mw-650px">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-header" id="kt_modal_add_user_header">
                                    <!--begin::Modal title-->
                                    <h2 class="fw-bolder">Add Districts</h2>
                                    <!--end::Modal title-->
                                    <!--begin::Close-->
                                    <div class="btn btn-icon btn-sm btn-active-icon-primary"
                                        data-kt-users-modal-action="close">
                                ...
                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                    ...
                                    <form id="kt_modal_add_user_form" class="form"
                                        action="{{ route('districts.store') }}" method="POST">
                                        <!--begin::Scroll-->
                                        @csrf
                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll"
                                            ...
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" name="name"
                                                    ...
                                                    placeholder="districts" value="Quận Gò Vấp" />
                                                <!--end::Input-->
                                            </div>
                                            <!--end::Input group-->
                                        </div>
            ...
            <div class="card-body py-4">
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_district" class="table table-row-bordered gy->
                    <!--begin::Table head-->
                    <thead>
                        <!--begin::Table row-->
                                        ...
                                        <form action="{{ route('districts.destroy', $district->id) }}" method="POST">
                                            ...
                                            <div class="menu-item px-3">
                                               <a href="{{route('districts.edit',$district->id)}}"
                                                    class="menu-link px-3"> <button class="btn btn btn-light btn-lg" >Edit</button></a>
                                            </div>
                                            <!--end::Menu item-->
                                            <!--begin::Menu item-->
                                            <div class="menu-item px-3">
                                                    <button type="submit" class="btn btn btn-light btn-lg">DELETE</button>
