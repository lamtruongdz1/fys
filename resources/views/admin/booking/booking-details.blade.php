<x-admin-app-layout title="Thông tin chi tiết đặt sân">
                    ...
                    <div class="card-body p-3 pt-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-12">
                                <div class="d-flex">
                                    <div>
                                        <img src="https://www.sporta.vn/assets/default_venue_1-7b24d4b210f6a19919f75503d8b6b5d2c2d75206c1a637e2431d9e87ebed2524.jpg"
                        ...
                        <div class="row">
                            <div class="col-lg-5 col-md-6 col-12">
                                ...
                                <div
                                    ...
                                    <img class="w-10 me-3 mb-0" src="{{ asset('backend/img/logos/mastercard.png') }}"
                                        alt="logo">
                                    <h6 class="mb-0">
                                        ****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;****&nbsp;&nbsp;&nbsp;7852</h6>
                                </div>
                                        ...
                                        <div class="d-flex flex-column">
                                            ...
                                            <span class="mb-2 text-xs">Email: <span
                                                    class="text-dark ms-2 font-weight-bold"><a
                                                        ...
                                                        data-cfemail="0a6566637c6f784a687f7878637e6524696567">[email&#160;protected]</a></span></span>
                                            <span class="text-xs">Số điện thoại: <span
                                                    class="text-dark ms-2 font-weight-bold">0562402540</span></span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
