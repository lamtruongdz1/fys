<x-admin-app-layout title="Thêm sân mới">
                        ...
                        <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                            <div class="multisteps-form__progress">
                                ...
                                <button class="multisteps-form__progress-btn" type="button" title="Media">2.
                                    Ảnh</button>
                                <button class="multisteps-form__progress-btn" type="button" title="Socials">3. Thông tin
                                    chủ sân</button>
                                <button class="multisteps-form__progress-btn" type="button" title="Pricing">4. Giá
                                    cả</button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="multisteps-form__content">
                                    <div class="row mt-3">
                                        ...
                                        <div class="col-12 col-sm-6 mt-3 mt-sm-0">
                                            <div class="input-group input-group-dynamic">
                                                <label for="exampleFormControlInput1" class="form-label">Sức chứa
                                                    tối đa </label>
                                                <input class="multisteps-form__input form-control" type="number" min="1"
                                                    max="20" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 mt-sm-3 mt-5">
                                            ...
                                            Đóng cửa:<input type="time" name="ketthuc" id="ketthuc"
                                                class="form-control">
                                        </div>
                                    </div>
                                    <div class="button-row d-flex mt-4">
                                        <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button"
                                            title="Next">Tiếp tục</button>
                                    </div>
                                </div>
                            </div>
                            <!--single form panel-->
                                ...
                                <div class="multisteps-form__content">
                                    ...
                                    <div class="button-row d-flex mt-4">
                                        <button class="btn bg-gradient-light mb-0 js-btn-prev" type="button"
                                            title="Prev">Trở lại</button>
                                        <button class="btn bg-gradient-dark ms-auto mb-0 js-btn-next" type="button"
                                            title="Next">Tiếp tục<nav></nav></button>
                                    </div>
                                </div>
                            </div>
                            <!--single form panel-->
                                    ...
                                    <div class="row">
                                        <div class="col-3">
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <input type="number" class="form-control w-100" id="exampleInputEmail1"
                                        ...
                                        <div class="col-4">
                                            <div class="input-group input-group-dynamic">
                                                ...
                                                <input type="text" class="form-control w-100" id="exampleInputText1"
